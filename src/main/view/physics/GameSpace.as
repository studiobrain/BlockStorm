	...
	public class GameSpace extends Sprite
	{
		...
		private function addBoundries():void
		{
			...
			this.floor  = new Polygon(
				Polygon.rect(0, BlockStorm.stageHeight * 0.95, BlockStorm.stageWidth, 100));
		...
		public function isColor(a:Body, b:Body):Boolean
		{
			...
			return a.userData.graphic.parent.color == b.userData.graphic.parent.color ? true : false;
		}
